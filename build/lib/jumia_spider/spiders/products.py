...
# This spider is for all the products to find the cheapest on jumia
class ProductsSpider(scrapy.Spider):
    name = 'products'
    allowed_domains = ['jumia.ug/']
    # home_living = ['https://jumia.ug/home-living/', 
    # women_fashion=  'https://www.jumia.ug/women-s-fashion/']
    # supermarket=  'https://www.jumia.ug/groceries/']
    # beauty_corner=  'https://www.jumia.ug/beauty-corner/']
    start_urls = ['https://www.jumia.ug/women-s-accessories/']
